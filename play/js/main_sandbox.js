...
function main(config){
	...
	Loader.onload = function(){
		...
		var votingSystems = [
			...
			{name:"Normalised", voter:NormalisedScoreVoter, election:Election.score, margin:4},
			{name:"STAR", voter:NormalisedScoreVoter, election:Election.star}
		];
